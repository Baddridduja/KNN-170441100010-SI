...
data_orj = pd.read_csv("perpustakaan.csv")

### Mengambil semua data untuk percobaan
data = data_orj.loc [:,'Visitor':'book code']

### Mengambil 3 kolom
data_knn = data[['Age','book code','loan amount']]
...
x,y = data_knn.loc[:,data_knn.columns != 'book code'], data_knn.loc[:,'book code']
